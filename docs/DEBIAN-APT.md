...
```bash
curl -fLO https://github.com/ItzGlace/vaxa-vm/releases/download/v0.1.1/vexa-vm_0.1.1_amd64.deb
curl -fLO https://github.com/ItzGlace/vaxa-vm/releases/download/v0.1.1/vexa-vm_0.1.1_amd64.deb.sha256
sha256sum -c vexa-vm_0.1.1_amd64.deb.sha256
...
dpkg-deb --info dist/vexa-vm_0.1.1_amd64.deb
```
